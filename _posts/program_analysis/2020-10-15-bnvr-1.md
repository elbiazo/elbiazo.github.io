...
Part 1 of this series will be more on the basic of Binary Ninja Scripting rather then program analysis.
...
Binary Ninja is great SRE when you want to do program analysis or automate things. The script I have demonstrated on this blog took less than 30 minutes! Try modifying this script to be more generic and running the script again on a real target. You will get alot more results. Thank you guys for reading my blog!
